...
typedef enum{
	LOGISTIC, RELU, RELIE, LINEAR, RAMP, TANH, PLSE, LEAKY, ELU, LOGGY, STAIR, HARDTAN, LHTAN, CRELU
} ACTIVATION;
...
data load_data_old(char **paths, int n, int m, char **img_labels, int k, int w, int h);
